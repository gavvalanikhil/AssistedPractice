...
public class EmployeeController {
	...
	public Employee getEmployeeInfo() {
		Employee emp1=new Employee(100,"nikhil",60000);
		return emp1;
	...
	public List<Employee> getAllEmployeeDetails() {
		...
		listOfEmp.add(new Employee(1,"hari",5000));
		listOfEmp.add(new Employee(2,"sony",5000));
		listOfEmp.add(new Employee(3,"likhita",5000));
		return listOfEmp;

...
//     //alert("name fro\m session storage "+obj1+" name from local storage "+obj2)
//     document.getElementById("out").innerHTML=("name fro\m session storage "+obj1+" name from local storage "+obj2)
